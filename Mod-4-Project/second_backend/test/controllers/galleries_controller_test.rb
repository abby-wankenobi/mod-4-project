...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { name: @gallery.name, user_id: @gallery.user_id } }, as: :json
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { name: @gallery.name, user_id: @gallery.user_id } }, as: :json
    assert_response 200
  end
