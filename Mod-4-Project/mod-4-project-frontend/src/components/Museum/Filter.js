...
export default class Filter extends React.Component{
  constructor(){
    ...
    this.state = {
      ...
      types: ['Paintings', 'Landscapes', 'Portraits', 'Still lifes', 'Biblical scenes', 'Daily life paintings', 'History scenes', 'Myths and symbols', 'Sculpture', 'Marble', 'Bronze', 'Wood', 'Terracotta','Furniture and interiors','Doll houses', 'Taperstries', 'Chests and cupboards', 'Chairs, sofas and beds', 'Writing tables', 'Fashion', 'Costumes', 'Accessories', 'Watches', 'Jewels', 'Applied Arts', 'Noble metals', 'Base metals', 'Glass', 'Ceramics', 'Textiles', 'Weapon and ship models', 'Firearms', 'Cannons', 'Daggers, sabres and foils', 'Ship models', 'Armour','Works on paper', 'Prints', 'Drawings', 'Photographs', 'Asian art', 'Asian sculptures', 'Works on paper', 'Asian interior'],
      category: '',
      option: ''
